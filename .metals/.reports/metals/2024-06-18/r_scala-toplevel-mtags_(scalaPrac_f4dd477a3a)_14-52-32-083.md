error id: file://<WORKSPACE>/lecturesCode/max.scala:[953..956) in Input.VirtualFile("file://<WORKSPACE>/lecturesCode/max.scala", "def max(x:Int,y:Int):Int=if (x>y) x else y
