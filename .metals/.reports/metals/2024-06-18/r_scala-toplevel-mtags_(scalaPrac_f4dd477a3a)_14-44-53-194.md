error id: file://<WORKSPACE>/lecturesCode/max.scala:[958..958) in Input.VirtualFile("file://<WORKSPACE>/lecturesCode/max.scala", "def max(x:Int,y:Int):Int=if (x>y) x else y
